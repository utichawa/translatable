...
1. The translatable model `Country` should [use the trait](http://www.sitepoint.com/using-traits-in-php-5-4/) `Utichawa\Translatable\Translatable`.
...
Examples for all the package features can be found [in the code](https://github.com/utichawa/Translatable/tree/master/tests/models) used for the [tests](https://github.com/utichawa/Translatable/tree/master/tests).

#### I need help!

Got any question or suggestion? Feel free to open an [Issue](https://github.com/utichawa/Translatable/issues/new).
