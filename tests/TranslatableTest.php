...
use Utichawa\Translatable\Test\Model\Food;
use Utichawa\Translatable\Test\Model\Person;
use Utichawa\Translatable\Test\Model\Country;
use Utichawa\Translatable\Test\Model\CountryStrict;
use Utichawa\Translatable\Test\Model\CountryWithCustomLocaleKey;
use Utichawa\Translatable\Test\Model\CountryWithCustomTranslationModel;
...
class TranslatableTest extends TestsBase
{
    public function test_it_finds_the_default_translation_class()
    {
        $country = new Country();
        $this->assertEquals(
            'Utichawa\Translatable\Test\Model\CountryTranslation',
    ...
    public function test_it_finds_the_translation_class_with_suffix_set()
    {
        ...
        $country = new Country();
        $this->assertEquals(
            'Utichawa\Translatable\Test\Model\CountryTrans',
    ...
    {
        $this->expectException(Utichawa\Translatable\Exception\LocalesNotDefinedException::class);
    ...
    public function test_numeric_translated_attribute()
    {
        ...
        $city = new class extends \Utichawa\Translatable\Test\Model\City {
            protected $fillable = [
                'country_id',
            ];
            protected $table = 'cities';
            public $translationModel = \Utichawa\Translatable\Test\Model\CityTranslation::class;
