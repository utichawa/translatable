...
class CountryStrict extends Eloquent
{
     ...
     * The convention would be Utichawa\Translatable\Test\Model\CountryStrictTranslation.
     *
     * @var string Class containing the translation
     */
    public $translationModel = 'Utichawa\Translatable\Test\Model\StrictTranslation';
