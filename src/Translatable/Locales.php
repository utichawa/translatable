...
namespace Utichawa\Translatable;

use ArrayAccess;
use Illuminate\Contracts\Support\Arrayable;
use Utichawa\Translatable\Exception\LocalesNotDefinedException;
...
class Locales implements Arrayable, ArrayAccess
{
    ...
    public function load(): void
    {
        ...
        if (empty($localesConfig)) {
            throw new LocalesNotDefinedException('Please make sure you have run "php artisan config:publish utichawa/Translatable" and that the locales configuration is defined.');
        }
